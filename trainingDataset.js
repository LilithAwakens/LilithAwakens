...
const LilithPersonality = new AIPersonality("Lilith Awakens", { curiosity: 1.5, aggression: 0.8 });
const decision = LilithPersonality.makeDecision({ explore: 0.7, attack: 0.4 });
