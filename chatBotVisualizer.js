...
function showTypingIndicator() {
    ...
    typingIndicator.innerHTML = `<strong>Lilith Awakens:</strong> <em>Typing...</em>`;
...
function sendMessage() {
    ...
    setTimeout(() => {
        ...
        appendMessage('Lilith Awakens', botMessage);
...
function generateResponse(userMessage) {
    ...
    // Boundary for inappropriate questions
        ...
        return "Lilith Awakens will not respond to inappropriate language.";
    }
    }
